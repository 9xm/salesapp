...
<script>
    $(document).ready(function () {
        ...
        function linkExtraAdded(obj){
            return obj+'<div class="linkExtra"></div>';
        ...
        oTable = $('#SLData').dataTable({
            ...
            'fnInitComplete': function(settings) { 
                ...
                $("#SLData .row_status").each( function(){
                    console.log($(this).text());
                    //<i class="fa fa-chain"></i>
                    var detailLink=$(this).parents('tr.invoice_link').find("li.detailLink a").attr("href");
                    var extraLink='<a href="'+detailLink+'"><i class="fa fa-chain"></i>Detail</a>';
                    if($(this).text() == 'Completed'){

                        $(this).parents('tr.invoice_link').find("li.addTaskLink").remove();
                    }else{
                        var addTaskLink=$(this).parents('tr.invoice_link').find("li.addTaskLink a").attr("href");
                         extraLink +=' | <a href="'+addTaskLink+'"><i class="fa fa-chain"></i>Add Task</a>';
                    }
                    $(this).parents('tr.invoice_link').find(".linkExtra").html(extraLink);
                });
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, {"mRender": linkExtraAdded}, null, null,null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment}, {"bVisible": false}, {"bSortable": false}],
