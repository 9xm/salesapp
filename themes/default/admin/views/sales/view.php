        ...
        echo '</p></div>';
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-right">
                        ...
                        <div class="col-xs-10">
                           ...
                           // print_r($customer_site->customer_site);
                            //echo 'aaaaaaaaaaaaaaa='.$inv->customer_site;
                            if (!empty($customer_site->customer_site)) {
                                echo '<br><strong>Customer Site:</strong> ' . $customer_site->customer_site;
                            }
                            echo '<br><strong>Employee Name:</strong> ' . $employee_name;
                ...
                <div class="col-xs-5">
                    ...
                    <div class="col-xs-10">
                        ...
                        <p>&nbsp;</p>
                        <p style="font-weight:bold;">PO Number: <?= $inv->po_number; ?></p>
                        <p style="font-weight:bold;">PO Date: <?= (!empty($inv->po_date))? date('d/m/Y',strtotime($inv->po_date)): ''; ?></p>
                        <p style="font-weight:bold;">Engine No: <?= $inv->engine_no; ?></p>
                        <p style="font-weight:bold;">Service Type: <?= $inv->service_type; ?></p>
                        <?php if(!empty($inv->from_quote)){ ?>    
                        <?php if(!empty($pi_number)){ ?>
                        <p>&nbsp;</p>
                        <p style="font-weight:bold;">PI Number: <?= $pi_number; ?></p>
                        <p style="font-weight:bold;">PI Date: <?= (!empty($pi_date))? date('d/m/Y',strtotime($pi_date)): ''; ?></p>
