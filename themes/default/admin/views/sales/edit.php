...
<script type="text/javascript">
    ...
    ?>
        ...
        localStorage.setItem('customersite', '<?= $inv->customer_site ?>');
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    echo form_input($warehouse_input);
                                    ...
                                    <div class="col-md-3">
                                            <div class="form-group"><label>Customer Site</label>
                                            <select name="customer_site" id="customer_site" class="form-control input-tip select" data-placeholder=" select customer site" required="required" style="width: 100%;" >
                    ...
                    foreach ($employees as $employee) {
                        $emp[$employee->id] = $employee->first_name.' '.$employee->last_name;
                    }
                    echo form_dropdown('employee_id', $emp, ($_POST['employee_id'] ??  $inv->employee_id), 'id="slemployee" class="form-control input-tip select" data-placeholder=" select employee" required="required" style="width:100%;" '); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('po_number', (!empty($inv->po_number) ? $inv->po_number : ''), 'class="form-control input-tip" id="ponumber"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>PO Date</label>
                                            <?php echo form_input('po_date', (!empty($inv->po_date) ?  date('d/m/Y',strtotime($inv->po_date)): ''), 'class="form-control input-tip  datetime" id="podate"'); ?>
                                        </div>
                                    </div>  
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Engine No</label>
                                            <?php echo form_input('engine_no', (!empty($inv->engine_no) ? $inv->engine_no : ''), 'class="form-control input-tip" id="engineno"'); ?>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label>service_type</label>
                                            <?php echo form_input('service_type', (!empty($inv->service_type) ? $inv->service_type : ''), 'class="form-control input-tip" id="servicetype"'); ?>
                                        </div>
                                    </div>
                                    <?php if(!empty($inv->from_quote)){ ?>
                                        <div class="col-md-3">
                                        <div class="form-group">
                                            <label>PI Number</label>
                                            <input type="text" readonly value="<?= $pi_number ?>" class="form-control input-tip">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>PI Date</label>
                                            <input type="text" readonly value="<?= (!empty($pi_date))? date('d/m/Y',strtotime($pi_date)): ''; ?>" class="form-control input-tip">
                                        </div>
                                    </div>
