        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    echo form_dropdown('employee_id', $emp, ($_POST['employee_id'] ?? ''), 'id="slemployee" class="form-control input-tip select" data-placeholder=" select employee" required="required" style="width:100%;" '); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input( 'po_number', '', 'class="form-control  input-tip" id="ponumber"' ); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>PO Date</label>
                                            <?php echo form_input('po_date', '', 'class="form-control input-tip  podate" id="podate"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Engine No</label>
                                            <?php echo form_input('engine_no', '', 'class="form-control input-tip  engineno" id="engineno"'); ?>
                                        </div>
                                    </div>
                                    <?php if(isset($from_quote)){ 
                                        echo form_hidden('from_quote', $from_quote); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('service_type', '', 'class="form-control input-tip  servicetype" id="servicetype"'); ?>
                                        </div>
                                    </div>
