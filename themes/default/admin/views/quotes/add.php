                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('pi_number', '', 'class="form-control input-tip" id="pinumber"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>PI Date</label>
                                            <?php echo form_input('pi_date', '', 'class="form-control input-tip  pidate" id="pidate" autocomplete="off"'); ?>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('customer_site', '', 'class="form-control input-tip  customersite" id="customersite"'); ?>
                                        </div>
                                    </div>
