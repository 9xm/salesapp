                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('	pi_number', (!empty($inv->pi_number) ? $inv->pi_number : ''), 'class="form-control input-tip" id="	pinumber"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>	Pi Date</label>
                                            <?php echo form_input('	pi_date', (!empty($inv->pi_date) ? $inv->pi_date : ''), 'class="form-control input-tip" id="	pidate"'); ?>
                                        </div>
                                    </div>
                                   ...
                                   <?php /* <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('po_number', (isset($_POST['po_number']) ? $_POST['po_number'] : $inv->po_number), 'class="form-control input-tip" id="ponumber"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>PO Date</label>
                                            <?php echo form_input('po_date', (isset($_POST['po_date']) ? $_POST['po_date'] : date('d/m/Y',strtotime($inv->po_date))), 'class="form-control input-tip  datetime" id="podate"'); ?>
                                        </div>
                                    </div> */ ?>
                                </div>
                            </div>
