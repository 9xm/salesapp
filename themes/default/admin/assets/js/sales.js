$(document).ready(function (e) {
    ...
    function customerSite(customer_id){
        var customer_site = localStorage.getItem('customersite');
        $.ajax({
            type:'get',
            url: site.base_url + 'customers/getCustomerSite',
            dataType: 'json',
            data:{customer_id:customer_id },
            success: function(data){
                
               $("#customer_site").html(data.option);
              
               $("#customer_site").val(customer_site).select2();
            }
        });
    ...
    if ((slcustomer = localStorage.getItem('slcustomer'))) {
        customerSite(slcustomer);
       // console.log($customer.val(slcustomer));
